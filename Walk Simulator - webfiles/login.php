...
<head>
    <head>
        ...
        <title>Walk simulator - Login</title>		
		<!-- Meta Description -->
						...
						<div class="col-md-7 col-md-offset-1 wow animated fadeInRight">
							<div class="welcome-block"><br><br><br><br><br><br><br><br>	
								 ...
								 <form action="loginverify.php" method="POST">
									...
									<span>Forgot your password? We can't help you either... :D</span><br>
                                    <span>Dont have an account yet? <a href="usersignup.php" style="color: #cccccc;" >Click here to sign up!</a></span><br><br>									
									<button type="submit" id="submit" class="btn btn-effect btn-blue"><b>Log in</b></button>
								 <form> 
